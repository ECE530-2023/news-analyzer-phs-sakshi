...
def insert_paragraph(doc_id, sentiment = None):
    insert_para_query = '''INSERT INTO paragraphs (doc_id, sentiment) VALUES (?,?)'''

    id = execute_insert_query(insert_para_query,(doc_id,sentiment))
    if id == False:
