...
class TestFileUpload(unittest.TestCase):
    ...
    def test_upload_document_success(self, mock_analyze_file, mock_upload_file_to_s3):
        # Mock file object
        ...
        # Check that the upload_file_to_s3 and analyze_file functions were called with the correct arguments
    ...
    @patch('src.FileUploader.upload_file.id_token.verify_oauth2_token', return_value={'sub':'test user'})
